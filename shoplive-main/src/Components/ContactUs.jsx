...
function ContactUs() {
  const [detail, setdetail]=useState({  
   ...
   const handlesubmit=(e)=>{
    ...
    Swal.fire({
      position: 'center',
      icon: 'success',
      title: 'Form has been sent Succesfully',
  ...
  return (
    ...
    <div className='col-md-6'>
       ...
       <h5><span className='contact'>Contact Us</span></h5>
        ...
        <div className='social'>
            <h5><span className='contact'>Follow Us</span></h5>
        ...
        <h5><span className='contact'>Get In Touch With Us!</span></h5>
